...
c.HTMLExporter.embed_images = True  # optional, embeds images directly
...
## Override font color for body and notebook cells
## for Astro theme matching
#style_tag = soup.new_tag("style")
#style_tag.string = """
#body, .jp-Notebook, .jp-Notebook .jp-Cell {
#    color: var(--astro-text, #000) !important;
